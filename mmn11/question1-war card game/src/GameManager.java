...
public class GameManager
{
	...
	public static void divideDecks()
	{
		...
		if (Player1Deck == null)
			Player1Deck = new DeckOfCards(false);// get empty deck
		else
			Player1Deck.clearDeck();

		if (Player2Deck == null)
			Player2Deck = new DeckOfCards(false);// get empty deck
		else
			Player2Deck.clearDeck();

		DeckOfCards newDeck = new DeckOfCards(true);// get fool deck
		newDeck.shuffle();
	...
	public static void playTurn()/* play turn */
	{
		...
		if (Player1Deck.getCardFromTop().get_value() > Player2Deck.getCardFromTop().get_value())
		{
			myDialogBox(
	...
	public static void warStage(DeckOfCards tempDeck)
	{
		...
		{
			if (Player1Deck.getCardFromTop().get_value() > Player2Deck.getCardFromTop().get_value())/* if player 1 wins */
			{
			...
			{
				if (Player1Deck.getCardFromTop().get_value() < Player2Deck.getCardFromTop()
						.get_value())/* if player 2 wins */
				{
					tempDeck.addCardAtBottom(Player1Deck.removeCardFromTop());/*
